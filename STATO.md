...
| **CAUSA DI FONDO — postazione Cristina serve dati stantìi** | Diagnosi ripetuta 3 volte nella stessa sessione: il server Directus è **sempre corretto**, ma la vista nel browser di Cristina è vecchia/cachata. (1) Morlupo B: le sue modifiche erano salvate, lei le credeva perse. (2) Delete di A: mai arrivato al server, lei lo credeva cancellato. (3) "La disabilità non è un superpotere" (`047749e5`): sul server foto + didascalia "Foto di Erik Mclean su Unsplash" + `stato=published`, lei vede bozza senza didascalia. **Le scritture arrivano, le letture sono stantìe.** Probabile cache browser/proxy o bundle Directus stantìo su quella macchina (nuova postazione segreteria, setup 2026-07-14). **Da diagnosticare a monte** — è la radice che genera duplicati e falsi "non funziona". |
