...
| TRANS-FLOW-01 (traduzione manuale) | ⚠️ funzionante ma fragile — vedi bug JSON malformato del 2026-08-04 in `STATO.md` § [BUG] Segnalazioni 2026-08-04. Ora superata in pratica dalla traduzione automatica sotto, per i nuovi articoli. |
