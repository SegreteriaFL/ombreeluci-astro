...
Soluzioni migliori
- **C** - È necessario che i genitori discutano tra di loro in privato ed intervengano sul bambino di comune accordo.

- **B** - Questa soluzione dimostra la capacità dei genitori di staccarsi dal figlio (quando la situazione lo permette), di prendere un po’ di tempo per la vita di coppia, e di rispondere positivamente all’offerta di aiuto dopo aver chiarito il modo migliore di star vicino al bambino.

- **C** - Per raggiungere l’obiettivo finale di un comportamento corretto si fissano obiettivi intermedi progressivi.

- **D** - Si evita il rischio di rinforzare il comportamento problematico; in un momento successivo può essere opportuno procedere ad una più completa analisi del problema.

- **C** - Questa via implica sia un rapporto chiaro con i parenti, sia la possibilità di mantenere la linea educativa già stabilita.

- **D** - Si evita stabilmente il comportamento indesiderato, è necessario interrompere l’azione autolesionista guidando fisicamente il bambino verso un’attività che impedisca il ripetersi della prima.

- **A** - Questo tipo di intervento richiede la massima coerenza e costanza nell’applicazione per produrre risultati positivi. Quindi, in nessun caso il comportamento problematico può passare inosservato.

- **D** - Il genitore con la sua presenza, limitata a brevi momenti, tranquillizza il bambino senza però rinforzare il comportamento problematico perché lo gratifica solo quando si è calmato. Queste presenze vanno progressivamente limitate.

- **A** - Alternativa migliore nella maggior parte dei casi. Al bambino viene tolto il piacere di mangiare il cibo rubato e il piacere di andare subito a giocare. Privato delle due gratificazioni, dovrebbe rinunciare al comportamento problematico.