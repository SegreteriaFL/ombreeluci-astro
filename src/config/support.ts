/**
 * Config pagina Sostieni / Support (donazione PayPal, bonifico, 5×1000).
 */
...
/** Importi suggeriti: scelta rapida 5 / 10 / 20 / Altro */
export const AMOUNT_CHIPS = [5, 10, 20] as const;
