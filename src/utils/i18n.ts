...
export const translations: Record<Locale, Record<string, string>> = {
  it: {
    ...
    home_magazine_archive: 'Archivio completo',
    home_magazine_all_issues: 'Tutti i numeri',
    home_magazine_archive_link: 'Tutti i numeri in archivio →',
  ...
  en: {
    ...
    home_magazine_archive: 'Full archive',
    home_magazine_all_issues: 'All issues',
    home_magazine_archive_link: 'All issues in the archive →',
