...
import { b as getThemesWithSlugs } from './taxonomy_CiRm90XT.mjs';
/* empty css                            */
...
const periodo_label = "Ottobre – Dicembre";
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Header;
  const { pathname = Astro2.url.pathname, alternateArticleUrl = null, lang: langProp } = Astro2.props;
  const lang = langProp ?? getLangFromUrl(pathname);
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  const aboutLinks = [
    ...
    { nome: "Newsletter", slug: "/newsletter" }
  ];
  const legalLinks = [
