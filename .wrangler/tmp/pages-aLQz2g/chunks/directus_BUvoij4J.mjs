...
const DIRECTUS_URL = process.env.DIRECTUS_URL?.trim() || DEFAULT_DIRECTUS_PUBLIC;
...
export { COPERTINA_IMG_ONERROR as C, PLACEHOLDER_COPERTINA as P, getAllArticoli as a, getAllNumeriRivista as b, getNumeroImageUrl as c, getAllAutori as d, getAutoreImageUrl as e, getCategoriaDescrizione as f, getArticoloCopertinaSrc as g, getArticoliInEvidenza as h, directusCredsFromAstroLocals as i, getCommentiForArticolo as j, getArticoloBySlug as k, getArticoliBySlugList as l };
