...
import { c as createComponent, m as maybeRenderHead, a as addAttribute, r as renderTemplate, b as createAstro, h as defineScriptVars, d as renderComponent, F as Fragment, u as unescapeHTML } from '../../chunks/astro/server_CgTYz_Tl.mjs';
import { g as getArticoloCopertinaSrc, i as directusCredsFromAstroLocals, j as getCommentiForArticolo, k as getArticoloBySlug, l as getArticoliBySlugList, C as COPERTINA_IMG_ONERROR, e as getAutoreImageUrl } from '../../chunks/directus_BUvoij4J.mjs';
import { g as getPlaceholder, $ as $$ArticleCard } from '../../chunks/ArticleCard_Bmok_ryk.mjs';
import { $ as $$BaseLayout } from '../../chunks/BaseLayout_iVPiOiwI.mjs';
/* empty css                                     */
import { h as getThemeLabel, f as getCategorySlugForArticle, a as getLabels, g as getMegaclusterForArticle } from '../../chunks/taxonomy_CiRm90XT.mjs';
...
const $$Commenti = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const ui = lang === "en" ? {
    heading: commenti.length > 0 ? `${commenti.length} comment${commenti.length > 1 ? "s" : ""}` : "Comments",
    ...
    heading: commenti.length > 0 ? `${commenti.length} comment${commenti.length > 1 ? "i" : ""}` : "Commenti",
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": articleTitle, "description": metaDescription, "ogImage": articleImage, "ogType": "article", "lang": articolo.lang === "en" ? "en" : "it", "noindex": true, "alternateArticleUrl": alternateArticleUrl, "alternates": [
    ...
    "itemListElement": [
      ...
      ...categoryDisplay && categoryLink ? [{
        ...
        "item": `https://ombreeluci.it${categoryLink}`
      }] : [],
      { "@type": "ListItem", "position": categoryLink ? 3 : 2, "name": articleTitle }
    ]
  }))) })}` })} `;
