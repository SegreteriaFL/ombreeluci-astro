...
import { c as createComponent, d as renderComponent, r as renderTemplate, F as Fragment, u as unescapeHTML, m as maybeRenderHead, a as addAttribute } from '../chunks/astro/server_CgTYz_Tl.mjs';
import { $ as $$BaseLayout } from '../chunks/BaseLayout_iVPiOiwI.mjs';
import { $ as $$IssueCard } from '../chunks/IssueCard_9ADWQ0mu.mjs';
import { c as getRoleWeight, g as getMegaclusterForArticle, a as getLabels, f as getCategorySlugForArticle } from '../chunks/taxonomy_CiRm90XT.mjs';
import { D as DIARISTI } from '../chunks/diari_DNXJk5VJ.mjs';
import { d as getAllAutori, e as getAutoreImageUrl, a as getAllArticoli, g as getArticoloCopertinaSrc, P as PLACEHOLDER_COPERTINA, C as COPERTINA_IMG_ONERROR } from '../chunks/directus_BUvoij4J.mjs';
/* empty css                                 */
...
const numeriData = [
	...
	},
	{
		...
		titolo_numero: "Bollettino Fede e Luce",
		seo_description: "\"AMARE è accettare l'altro così com'è, lasciarsi investire",
	...
	},
	{
		...
		titolo_numero: "Bollettino Fede e Luce",
		seo_description: "\"Il Regno dei cieli è simile a un granellino di senapa, esso è il più piccolo di tutti i semi, ma una volta cresciuto è più grande degli altri!\" Matteo 13,31",
	...
	},
	{
		...
		seo_description: "\"Signore, Dammi soltanto un po' di bontà, perché io pensi alla felicità degli altri, prima di pensare alla mia; alla gioia degli altri, prima della mia...»Dammi soltanto un po' di bontà!\"-",
	...
	},
	{
		...
		seo_description: "Studiammo molte parole d'amore. Creammo molte parole d'amore. Partiti, infine, dal mondo, lasciamo, non dette, troppe parole d'amore. Ghàlib Asadu'llah",
	...
	},
	{
		...
		titolo_numero: "Bollettino Fede e Luce – 1980",
		seo_description: "Rivista Insieme di Fede e Luce: esperienze comunitarie, riflessioni spirituali e testimonianze dal movimento per l'integrazione di persone con disabilità e le loro famiglie.",
	...
	},
	{
		...
		seo_description: "Paralisi cerebrale. Cerchiamo di capire le difficoltà di chi ne è colpito dalla nascita. Non è facile restare aperti alla speranza, senza scoraggiarsi, senza paura di perder tempo, per periodi molto più lunghi del normale. E quel che potrebbe essere facile, e stimolante quando i figli sono piccoli, diventa gravoso e duro quando sono adulti.",
	...
	},
	{
		...
		seo_description: "“Chi accoglie voi, accoglie me”. La vita spirituale delle persone con disabilità mentale. Esperienze negative e positive di accoglienza nella vita cristiana. “Tutti sono chiamati alla Buona Notizia di Gesù, soprattutto dopo il dono del Battesimo…. Occorre un cambiamento di mentalità: ci immaginiamo che i fratelli in difficoltà bussino per chiedere aiuto, un sorriso, un appoggio.. .poi ci accorgiamo che vengono ad offrire un dono”( Card. Martini.)",
		descrizione_originale: "← Prec Succ → Numero 5 – Chi accoglie voi, accoglie me Anno 2, 1984 – Trimestrale: Gennaio, Febbraio, Marzo Sfoglia numero online Opzioni Download Sommario “Chi accoglie voi, accoglie me”. La vita spirituale delle persone con disabilità mentale. Esperienze negative e positive di accoglienza nella vita cristiana. “ Tutti sono chiamati alla Buona Notizia di Gesù , soprattutto dopo il dono del Battesimo… Occorre un cambiamento di mentalità: ci immaginiamo che i fratelli in difficoltà bussino per chiedere aiuto, un sorriso, un appoggio… poi ci accorgiamo che vengono ad offrire un dono”.( Card. Martini.) Editoriale Nessuno escluso di Carlo Maria Martini Perché lontano da Dio di Mariangela Bertolini Articoli “Lei non entra” di Olga Gammarelli Come le altre domeniche Anna di J.F Basta la porta aperta (domande in 6 parrocchie) di Sergio Sciascia Cosa dirvi di più di Stéphane Desmasièrez Chiediamo alle comunità religiose di Henri Faivre Cottolengo e Don Guanella – pregiudizi e realtà di Nicole Schulthes Rubriche Dialogo aperto n. 5 Vita Fede e Luce n. 5 Libri Dare a ciascuno una voce , Carlo M. Martini",
		descrizione_ai: null,
	...
	},
	{
		...
		seo_description: "In questo numero: Alcune esperienze concrete e le domande sulle criticità dell’integrazione scolastica. Ma anche una riflessione di Jean Vanier per ciascuno di noi: cerchiamo di non aver paura di scoprire il povero che è in noi. Infine, due storie di vita insieme: una famiglia che adotta e una casa-famiglia.",
	...
	},
	{
		...
		seo_description: "In questo numero: Voci di fratelli e sorelle di una persona con disabilità mentale. Si tace troppo spesso la loro sofferenza, spesso trascurati in questa loro pena segreta, temoni di parlarne con i loro genitori ma anche con gli “altri”…finiscono col tacere per timore di non essere capiti. Ma, per difficile che sia la situazione, val la pena di osare parlarne con qualcuno , non fosse altro che per non portare il peso",
	...
	},
	{
		...
		tipo_rivista: "ombre_e_luci",
		numero_progressivo: 12,
		display_title: "Numero 12 - Perchè mi guardi?",
		titolo_numero: "Perchè mi guardi?",
		...
		descrizione_originale: "← Prec Succ → Numero 12 – Perché mi guardi Anno 3, 1985 – Trimestrale: Ottobre, Novembre, Dicembre",
		descrizione_ai: null,
		anno_pubblicazione: 1985,
		anno_collezione: null,
		periodicita: "trimestrale",
	...
	},
	{
		...
		tipo_rivista: "ombre_e_luci",
		numero_progressivo: 13,
		display_title: "Numero 13 – Murati nell'oscurità e nel silenzio",
		titolo_numero: "Murati nell'oscurità e nel silenzio",
		seo_description: "Avere un figlio che non vede, non sente, non cammina, non comunica… una delle prove più traumatizzanti per una famiglia. Proviamo a descrivere la persona sordo cieca, ascoltiamo i suoi genitori e scopriamo quale grandi passi può fare con una educazione appropriata.",
		descrizione_originale: "← Prec Succ → Numero 13 – Murati nell’oscurità e nel silenzio Anno 3, 1986 – Trimestrale: Gennaio, Febbraio, Marzo",
		descrizione_ai: null,
	...
	},
	{
		...
		seo_description: "Le persone con disabilità: segno di contraddizione e fonte di unità. Padre Mihelcic: “Niente",
	...
	},
	{
		...
		seo_description: "Si parla sempre della madre. Tutti capiscono, comprendono la mamma di un figlio handicappato. Pochi parlano del padre e pochi se ne preoccupano. Questo numero è dedicato ai papà.",
	...
	},
	{
		...
		seo_description: "Incontrare un malato mentale è spesso difficile per diverse ragioni, sono tante le domande che pone questa condizione. Ma è importante che la persona e la sua famiglia non restino ai margini.",
	...
	},
	{
		...
		seo_description: "Due sacerdoti, una mamma, una suora francescana. Sono loro le voci che chiedono un posto nella Chiesa per ciascun figlio di Dio, anche con disabilità, e che operano con fede per \"non tradire le attese di Dio e le speranze di chi varca la soglia\" della Chiesa: la Buona Novella è per tutti!",
	...
	},
	{
		...
		seo_description: "Se non mancano le ombre della fatica e della rabbia di fronte alla disabilità di un figlio, come leggiamo nelle lettere del Dialogo Aperto, cerchiamo di non far mancare luci di speranza: dei genitori che ci sono passati, dell’esperienza amorevole di un’insegnante che indica quanto sia necessaria, oltre l’apprendimento, una serena vita di gruppo; di un’associazione -La Casa del Sole- che",
	...
	},
	{
		...
		seo_description: "«Ogni genitore che ha un figlio che può raggiungere una certa autonomia sa bene che non deve stringere con lui un rapporto di forte dipendenza” e insegnargli quanto più possibile, chiedendosi “Cosa non gli ho mai insegnato a fare",
	...
	},
	{
		...
		seo_description: "Numero interamente dedicato ai fratelli e sorelle delle persone con disabilità",
	...
	},
	{
		...
		display_title: "Numero 31 - Le comunità Fede e Luce",
		titolo_numero: "Le comunità Fede e Luce",
		seo_description: "Numero 31 – Le comunità Fede e Luce",
		descrizione_originale: "← Prec Succ → Numero 31 – Le comunità di Fede e Luce Anno VIII – Numero 3 – Luglio – Agosto – Settembre 1990",
		descrizione_ai: null,
		anno_pubblicazione: 1990,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		display_title: "Numero 34 - Così noi lavoriamo con gli altri",
		titolo_numero: "Così noi lavoriamo con gli altri",
		seo_description: "Numero 34 – Così noi lavoriamo con gli altri",
		descrizione_originale: "← Prec Succ → Numero 34 – Così noi lavoriamo con gli altri Anno IX – Numero 34 – Aprile – Maggio – Giugno 1991",
		descrizione_ai: null,
		anno_pubblicazione: 1991,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		seo_description: "I protagonisti di questo numero sono: Lelia, Giacomo, Roberta e Viviana. Le loro quattro brevi presentazioni dicono quanto può essere fatto per offrire un’esistenza serena e fruttuosa a chi, come loro, parte svantaggiato",
	...
	},
	{
		...
		display_title: "Numero 39 - Catechesi: perché nessuno sia dimenticato",
		titolo_numero: "Catechesi: perché nessuno sia dimenticato",
		seo_description: "Numero 39 – Catechesi: perché nessuno sia dimenticato",
		descrizione_originale: "← Prec Succ → Numero 39 – Catechesi: perché nessuno sia dimenticato Anno X – Numero 3 – Luglio – Agosto – Settembre 1992",
		descrizione_ai: null,
		anno_pubblicazione: 1992,
		anno_collezione: null,
	...
	},
	{
		...
		seo_description: "Fermati un momento. È utile ogni tanto. Questa volta per provare a capire le tante persone che, spesso, in un attimo, sono passati dalla vita normale a una vita diversa",
	...
	},
	{
		...
		display_title: "Numero 41 - 10 anni di Ombre e Luci: più che una rivista, una grande famiglia",
		titolo_numero: "10 anni di Ombre e Luci: più che una rivista, una grande famiglia",
		seo_description: "Numero 41 – 10 anni di Ombre e Luci: più che una rivista, una grande famiglia",
		descrizione_originale: "← Prec Succ → Numero 41 – 10 anni di Ombre e Luci: più che una rivista, una grande famiglia Anno XI – Numero 1 – Gennaio – Febbraio – Marzo 1993",
		descrizione_ai: null,
	...
	},
	{
		...
		seo_description: "Dall'archivio, un numero pieno di speranza per ricordarci che anche se apparentemente il cielo è molto nuvoloso, il sole c’è, e brilla con la luce di sempre.",
	...
	},
	{
		...
		display_title: "Numero 45 – Dio così lontano, così vicino",
		titolo_numero: "Dio così lontano, così vicino",
		seo_description: "I genitori di un figlio disabile,",
		descrizione_originale: "← Prec Succ → Numero 45 – Dio così lontano, così vicino Anno XII – Numero 1 – Gennaio – Febbraio – Marzo 1994",
		descrizione_ai: null,
	...
	},
	{
		...
		display_title: "Numero 49 - Vita affettiva e sessuale: questo bisogno così forte di amare e di essere amati",
		titolo_numero: "Vita affettiva e sessuale: questo bisogno così forte di amare e di essere amati",
		seo_description: "Numero 49 – Vita affettiva e sessuale: questo bisogno così forte di amare e di essere amati",
	...
	},
	{
		...
		seo_description: "Un numero \"ecologico\", tutto dedicato alla natura, alle piante, agli animali e al nostro pianeta terra: quante volte ci dimentichiamo di quanto è importante per noi e per la nostra salute fisica e mentale.",
	...
	},
	{
		...
		display_title: "Numero 71 - Accostarsi alla verità",
		titolo_numero: "Accostarsi alla verità",
		seo_description: "Un numero tosto dedicato a un tema enorme: la verità, di fronte alla quale non possiamo che rimanere umili e abbassare il capo come dice Mariangela nell'editoriale, e continuare a interrogarci col cuore e con la razionalità, come suggerisce Jean Vanier. Accostarsi alla verità vuol dire fare i conti con se stessi, genitori e figli, ecco allora gli interventi sulla gestione della frustrazione nei confronti dei figli adolescenti e la paura per le scelte",
		descrizione_originale: "← Prec Succ → Numero 71 – Accostarsi alla verità Anno XVIII – Numero 3 – Luglio – Agosto – Settembre 2000",
		descrizione_ai: null,
		anno_pubblicazione: 2000,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		display_title: "Numero 113 - Muoviti con chi non può muoversi",
		titolo_numero: "Muoviti con chi non può muoversi",
		seo_description: "Numero 113 – Muoviti con chi non può muoversi",
		descrizione_originale: "← Prec Succ → Numero 113 – Muoviti con chi non può muoversi Anno 29 – Numero 1 – Gennaio – Febbraio – Marzo 2011",
		descrizione_ai: null,
	...
	},
	{
		...
		display_title: "Numero 114 – Perché non io?",
		titolo_numero: "Perché non io?",
		seo_description: "Numero 114 – Perché non io?",
		descrizione_originale: "← Prec Succ → Numero 114 – Perché non io? Anno 29 – Numero 2 – Aprile – Maggio Giugno 2011",
		descrizione_ai: null,
		anno_pubblicazione: 2011,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		display_title: "Numero 115 – Difendere la fragilità di ognuno",
		titolo_numero: "Difendere la fragilità di ognuno",
		seo_description: "Numero 115 – Difendere la fragilità di ognuno",
		descrizione_originale: "← Prec Succ → Numero 115 – Difendere la fragilità di ognuno Anno 29 – Numero 3 – Luglio – Agosto – Settembre 2011",
		descrizione_ai: null,
		anno_pubblicazione: 2011,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		display_title: "Numero 129 – Quando non si è più soli, la vita risulta trasformata",
		titolo_numero: "Quando non si è più soli, la vita risulta trasformata",
		seo_description: "È il dono più difficile che la vita poteva darmi, ma senza chiedere mi dà tanto… Anche se ho avuto un altro destino di mamma, quello che conta è non sentirsi sole mai…",
		descrizione_originale: "← Prec Succ → Numero 129 – Quando non si è più soli, la vita risulta trasformata Anno 33 – Numero 1 – Gennaio – Febbraio – Marzo 2015",
		descrizione_ai: null,
	...
	},
	{
		...
		seo_description: "il valore della persona con disabilità all’interno della comunità cristiana e la necessaria solidarietà tra i componenti di una comunità",
	...
	},
	{
		...
		seo_description: "Le cose più importanti della vita, quelle che le danno senso, hanno bisogno di tempo e dell’\"altro\" in carne e ossa: l’amore, la fiducia, la stabilità delle relazioni, la gioia che non sia semplice e passeggero divertimento",
	...
	},
	{
		...
		display_title: "Numero 140 - Perché tu sei prezioso ai miei occhi",
		titolo_numero: "Perché tu sei prezioso ai miei occhi",
		...
		descrizione_originale: "← Prec Succ → Numero 140 – Perché tu sei prezioso ai miei occhi Anno 35, 2017 – Trimestrale: Ottobre, Novembre, Dicembre",
		descrizione_ai: null,
		anno_pubblicazione: 2017,
		anno_collezione: null,
		periodicita: "trimestrale",
	...
	},
	{
		...
		seo_description: "Come pensiamo e discutiamo della disabilità? In questo numero un dossier riflette sulle barriere comportamentali verso la persona con disabilità e rassegna alcune realtà sul territorio che cercano di abbattere questi muri.",
	...
	},
	{
		...
		seo_description: "L’importanza di raccontare sé stessi, le proprie difficoltà e le proprie gioie è al centro dei rapporti umani: ne parliamo in questo numero.",
	...
	},
	{
		...
		seo_description: "È uscito il nuovo numero di Ombre e Luci. All'interno: i 50 anni di Ombres et Lumiére, la cronaca dell'Incontro internazionale il Libano e le testimonianze dei giovani a Fano.",
	...
	},
	{
		...
		seo_description: "Da questo numero Ombre e Luci ha una nuova veste grafica e una nuova struttura dei contenuti. Il focus è dedicato alla disabilità nella vecchiaia. Inoltre l’intervista a Sergio Sciascia, storico componente della redazione.",
	...
	},
	{
		...
		display_title: "Numero 148 – L'incontro con la disabilità",
		titolo_numero: "L'incontro con la disabilità",
		seo_description: "In questo numero abbiamo voluto dare voce ad alcuni dei possibili incontri con la disabilità: in comunità, con gli amici, a lavoro.",
		descrizione_originale: "← Prec Succ → Numero 148 – L’incontro con la disabilità Anno 37, 2019 – Trimestrale: Ottobre, Novembre, Dicembre",
		descrizione_ai: null,
		anno_pubblicazione: 2019,
		anno_collezione: null,
		periodicita: "trimestrale",
	...
	},
	{
		...
		seo_description: "Indagando la costruzione di paradigmi e pratiche che siano davvero inclusivi, siamo giunti a conclusioni molto interessanti sul rapporto tra moda e disabilità.",
	...
	},
	{
		...
		seo_description: "Raccontiamo quando la disabilità è protagonista dello schermo, grande o piccolo che sia.",
	...
	},
	{
		...
		seo_description: "È un lungo viaggio nell’arte quello proposto dal nuovo numero di Ombre e Luci. L’intervista di apertura è a Sante Bandirali, co-fondatore di Uovonero. E ancora, la testimonianza di Stefano Nasuti, futuro trustee in base alla legge sul dopo di noi.",
	...
	},
	{
		...
		seo_description: "Questo ricchissimo numero – aperto dall’intervista a Giampiero Griffo, presidente della rete italiana disabilità e sviluppo – contiene, oltre al focus sulle adozioni, una gran bella sorpresa: la lettera del presidente Sergio Mattarella giunta in redazione.",
	...
	},
	{
		...
		seo_description: "Oggi, in Italia, per le persone con disabilità il lavoro è un diritto, una realtà o una chimera? Armati di qualche dato, abbiamo intrapreso un viaggio",
	...
	},
	{
		...
		descrizione_originale: "← Prec Succ → Numero 156 – Alle radici di cinquant’anni di storia Anno 39 – Numero 4 – Ottobre – Novembre – Dicembre 2021 Sommario Ai cinquant’anni di Fede e Luce abbiamo dedicato il focus di OL 4/2021: il menù è ricchissimo! C’è il racconto, con molti particolari inediti, della co-fondatrice Marie-Hélène Mathieu; ci sono i ritratti di tante persone a cui si deve il pellegrinaggio a Lourdes nel 1971 da cui tutto nacque – Loïc Proffit, che oggi ha 65 anni e vive all’Arca di Trosly (Angela Grassi), la battagliera suor Ida Maria Ferri e il genetista Jerome Lejeune, proclamato proprio quest’anno servo di Dio (Cristina Tersigni) – e ci sono le parole di uno dei partecipanti, Enzo Ferrazzoli (futuro co-firmatario della costituzione legale di FL Italia); chiude il focus Papa Francesco colto a «far comunità», nella cronaca dell’udienza dello scorso ottobre (Vito Giannulo). O&L si apre con l’intervista di Cristina Tersigni a Emanuela Posa: con lei arriviamo fino alla Repubblica Democratica del Congo dove la giovane cooperante si occupa di diversi progetti per bambini e adulti con disabilità. Il numero prosegue con la testimonianza di monsignor Intini (referente di FL presso la Cei) che, rif…",
		descrizione_ai: null,
		anno_pubblicazione: 2021,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		descrizione_originale: "← Prec Succ → Numero 157 – Mai per caso Anno 40 – Numero 1 – Gennaio – Febbraio – Marzo 2022 Sommario «Quando sono entrata nel movimento ho scoperto un mondo (…). Alcune disabilità non le avevo mai viste, non avevo avuto mai un compagno con handicap a scuola o al catechismo». Aveva vent’anni Angela Gattulli quando ha conosciuto Fede e Luce e trent’anni dopo, al secondo e «assolutamente» ultimo mandato da rappresentante legale dell’associazione, ripercorre con Giulia Galeotti le svolte importanti per la sua vita. E per il mandato di presidente in una realtà che, «aiutando tante famiglie a varcare la porta di casa», ha saputo darle la gioia di infangarsi come in una pozzanghera trovata per strada: un’esperienza che, dice Angela, dovremmo mettere a disposizione di quei giovani che vediamo oggi aver tanta necessità di esperienze belle e concrete. Il focus è invece dedicato agli animali: ne scrivono Nicla Bettazzi e Nadia Pastori, mamme di ragazzi con disabilità, sottolineando la possibile normalità sperimentata dai loro figli vicino a un animale. Conosciamo quindi Rodano, Pato e Romeo con gli occhi dei loro umani Laura Coccia, Simona Greco ed Edoardo: «Legami unici e indissolubili» che…",
		descrizione_ai: null,
	...
	},
	{
		...
		seo_description: "L'ultimo numero di Ombre e Luci è tutto dedicato ai giochi! Liberate la fantasia, a che gioco giochiamo?",
	...
	},
	{
		...
		descrizione_originale: "← Prec Succ → Numero 160 – Ruote nuove su occhi nuovi Anno 40 – Numero 4 – Ottobre – Novembre – Dicembre 2022 Editoriale Declinazioni di speranza di Cristina Tersigni Focus: Per pedalare tutti Otto giorni per vent’anni di Cristina Tersigni Tandem in Trentino di Andrea Posa Invertire gli addendi di Cristina Tersigni Bari scintillante di Cristina Tersigni «Ce l’abbiamo fatta!» di Giampaolo Mattei Articoli Alberta e la Rivoluzione di Giulia Galeotti Alla ricerca dell’altro da me di Giulia Cirillo Il piacere del contatto di Enrica Riera Il mondo come lo vediamo noi di Matteo Cinti Fiera di me stessa di Benedetta Mattei E.T. alla Bicoca di Giovanni Grossi Dall’archivio Avete mai provato… di Mariangela Bertolini Rubriche Campi di giochi Dialogo aperto Libri A sua immagine? a cura di A. Fontana e G. Merlo La più bella nuotata della mia vita , Anne Becker Abbassa il cielo e scendi , Giorgio Boatti Il grande cavallo blu di Irène Cohen-Janca e Maurizio A.C. Quarello",
		descrizione_ai: null,
		anno_pubblicazione: 2022,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		seo_description: "In questo numero ben ricco, la seconda puntata dell'inchiesta su medici e disabilità; stralci dal diario di Lino dal Premio Pieve Saverio Tutino, recensioni e tutte le rubriche.",
		descrizione_originale: "← Prec Succ → Numero 164 – (Ancora) pazienti? Anno 41 – Numero 4 – Ottobre – Novembre – Dicembre 2023 Sommario Accompagnato dalla Nativity dell’artista cinese He Qi, Giovanni Grossi riflette sulle contraddizioni del Natale, per arrivare a concludere: «Io vivo per conto mio aspettando la felicità che non ho mai raggiunto nella mia vita». Che questa capacità di non fermarsi a fronzoli e apparenze valga un po’ per tutti noi, aiutandoci a non far imbolsire la nostra capacità di amare ed esserci. Per il resto, proponiamo la seconda puntata dell’inchiesta su medici e disabilità, tra testimonianze e il prezioso incontro con Antonio Piscitelli, pediatra a Napoli.",
		descrizione_ai: null,
		anno_pubblicazione: 2023,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		seo_description: "Punti di vista e spunti di riflessione per interrogarci su possibilità e libertà di vivere il tempo libero (sarà poi davvero così libero?)",
		descrizione_originale: "← Prec Succ → Numero 165 – Uscire la sera Anno 42 – Numero 1 – Gennaio – Febbraio – Marzo 2024 Sommario «Nel quotidiano, andare a mangiare fuori per una persona con disabilità cos’è? Un diritto sacrosanto, un miraggio vicino ma inesistente, una fatica immane, una scelta complessa radicata nell’idea di cittadinanza e di comunità? O è tutto questo allo stesso tempo?» si domanda Giulia Galeotti nel suo pezzo di apertura del nuovo focus del numero di Ombre e Luci in arrivo nelle vostre case. Troverete punti di vista, spunti di riflessione per interrogarci su possibilità e libertà di vivere quel tempo libero (sarà poi davvero così libero?) che in tanti diamo pressoché per scontate o forse superflue. Avremo poi modo di conoscere meglio proprio quella Luciana Spigolon di cui avete trovato un testo in capo a questa newsletter: la sorella di Giorgio e Cristina, entrambi con una grave disabilità, ci racconta di un quotidiano tra conquiste e fatiche dalla provincia di Padova. E poi tanto altro! Le rubriche, le nostre recensioni di libri e spettacoli, le associazioni come quella sportiva di una squadra di Baskin in Puglia, con la cronaca di due partite di campionato molto partecipate sia dai g…",
		descrizione_ai: null,
	...
	},
	{
		...
		descrizione_originale: "← Prec Succ → Numero 166 – Il Paese giusto Anno 42 – Numero 2 – Aprile – Maggio – Giugno 2024 Sommario «Nessun diritto purtroppo si acquisisce una volta per tutte e non si può mai abbassare la guardia… Però quando una regola sentita come giusta, anche se inizialmente calata dall’alto, diviene coscienza, è difficile tornare indietro. Fu un buon vento». Così scrive Nicla Bettazzi aprendo il focus del nuovo numero di Ombre e Luci dedicato all’inclusione scolastica in Italia: un articolo che, tra storia personale e storia pubblica della legge 517/1977 (quella, per intenderci, che ha abolito le classi differenziali per gli alunni con disabilità), ci aiuta a conoscere meglio quel giusto avvenuto nel nostro Paese affinché il diritto all’istruzione fosse davvero garantito a ogni cittadino. Nel focus esperienze passate e attuali raccontano il bene di una scelta che, come sottolinea Laura Coccia, seppur nella «fatica» sa «nutrire i risultati migliori». Un Paese giusto si intravede anche in un supermercato che viene incontro a chi, nella condizione dello spettro autistico, vive con difficoltà la spesa: a raccontarcelo, intervistata da Cristina Tersigni, è Margaret Martino, presidente dell’ass…",
		descrizione_ai: null,
		anno_pubblicazione: 2024,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		descrizione_originale: "← Prec Succ → Numero 167 – Fare la Storia per ridare la vita Anno 42 – Numero 3 – Luglio-Agosto-Settembre 2024 Sommario Perché ricordare Franco Basaglia? Oltre l’occasione del centenario, scrive Giulia Galeotti, «il medico italiano è riuscito in un’impresa veramente storica: smettere di tenere “i matti” – categoria eterogenea per definizione, per stereotipo e per ignoranza – separati e lontani dalla vista dei “sani”». Dedichiamo così il focus del numero in arrivo a un centenario attuale, capace di trasformare pratiche e compiere svolte culturali che ci riguardano tutti. E poi: vacanze possibili senza mamma e papà? Sì, ci risponde Monica Leggeri raccontandoci un’estate diversa per Caterina. Laura Coccia prova invece a scalare i muri creati dalle tante domande inespresse per e attorno alla crescita di una bambina-ragazza-donna con paralisi cerebrale. A chiudere tre film per guardare oltre dal Biografilm Festival di Bologna (scrive il nostro critico cinematografico Claudio Cinus), le voci dalla formazione giovani di Lignano e gli immancabili diari di Benedetta Mattei e Giovanni Grossi. Buona lettura! Editoriale Attualità di un centenario di Cristina Tersigni Focus: Fare la Storia per…",
		descrizione_ai: null,
		anno_pubblicazione: 2024,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		descrizione_originale: "← Prec Succ → Numero 169 – Noi pellegrini Anno 43 – Numero 1 – Gennaio – Febbraio – Marzo 2025 Sommario Il 2025 è anno di pellegrinaggi, non solo per il Giubileo della Speranza aperto da papa Francesco, ma anche per i 50 anni di Fede e Luce in Italia. «Avventura umana profonda», «esperienza di conversione»: un pellegrinaggio, racconta padre Paul Gilbert , può essere l’opportunità di tessere relazioni e fissare incontri che daranno vera vita, una volta a casa, alla preghiera personale e slancio a cambiare qualcosa nel proprio quotidiano. «Una proposta audace, forse fuori moda» sottolineava Mariangela Bertolini nel 1978 quando invitava i giovani ad Assisi per seguire il cammino comunitario delle comunità di Fede e Luce.",
		descrizione_ai: null,
	...
	},
	{
		...
		descrizione_originale: "← Prec Succ → Numero 170 – Camminiamo insieme Anno 43 – Numero 2 – Aprile – Maggio – Giugno 2025 «U n pontificato che ha camminato assieme alle persone con disabilità» scrive Giulia Galeotti nel suo omaggio a papa Francesco: le voci del Dialogo Aperto lo testimoniano con vividezza. Il focus è dedicato ancora al tema del pellegrinaggio: da Lourdes a Santiago passando per le sale cinematografiche e per Pompei , che accoglierà le comunità di Fede e Luce nel prossimo settembre. Francesca Pellegrini racconta la sua esperienza da giovane lettrice e volontaria di Nati per Leggere in Toscana. Ma i film che parlano di autismo raccontano davvero l’autismo? Se lo chiede Niccolò Scarnato, attore autistico esordiente, nelle pagine dedicate agli Spettacoli. Poi, tutti pazzi per il padel ! Infine i nostri consigli di lettura e i diari di Benedetta e Giovanni . Tante cose che fanno la differenza! Editoriale Mio figlio ha degli amici di Cristina Tersigni Focus: Noi pellegrini – seconda puntata Quell’universo nella voce del vocabolario di Serena Sillitto Verso Pompei di Equipe tematica Pompei Scene e storie a cui ognuno può dare significato di Claudio Cinus A Santiago per mio figlio di Lucio Cammaro…",
		descrizione_ai: null,
		anno_pubblicazione: 2025,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		seo_description: "In continuità con il numero Sorelle Tutte dello scorso anno, l’ultimo Ombre e Luci dà voce a tre sacerdoti che vivono l'accoglienza della disabilità.",
		descrizione_originale: "← Prec Succ → Numero 171 – Fratelli tutti Anno 43 – Numero 3 – Luglio – Agosto – Settembre 2025 Sommario In ideale continuità con il numero Sorelle Tutte dello scorso anno, l’ultimo Ombre e Luci dà voce a tre sacerdoti che vivono l’accoglienza della disabilità, testimoniando una paternità pastorale autentica e feconda. Da Roma, Milano e Viterbo , arrivano esperienze diverse per misure e carismi: ciascuna traccia una strada possibile per una Chiesa chiamata davvero ad aprire le porte ad ogni fratello e sorella. Apre il numero l’intervista ad Antonio Piscitelli, dalla Campania, che racconta la rinnovata consapevolezza della bontà del percorso vissuto nelle comunità di Fede e Luce. Un’esperienza che, tra i vicoli di Napoli trentacinque anni fa, ha dato origine anche all’associazione La Scintilla , di cui parla una delle fondatrici, Claudia Noviello: percorsi differenti con la convinzione di «ritrovare spazi di umanità autentica». Seguono la testimonianza di tre anni di scuola superiore di Giulia Alberico, le cronache (o le critiche) dal Giubileo delle persone con disabilità dello scorso aprile e il racconto di Niccolò Scarnato, attore autistico, sul casting del film La Vita da Grandi…",
		descrizione_ai: null,
		anno_pubblicazione: 2025,
		anno_collezione: null,
		periodicita: null,
	...
	},
	{
		...
		sommario_lancio: "Paradigma Pompei, l'ultimo numero del 2025 di Ombre e Luci, racconta di un viaggio: un insieme di voci, riflessioni e testimonianze nate dal pellegrinaggio che Fede e Luce ha compiuto a settembre per festeggiare i suoi 50 anni. Un puzzle che diventa specchio di un modo nuovo e universale con cui poter vivere e affrontare gioie, salite, dolori e legami legati alla fragilità e alla disabilità. Ricordando sempre che la differenza non è mai un disvalore. E che solo insieme sarà possibile affrontare il futuro, con le sue luci e le sue ombre.",
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const latestArticles = sortedArticles.filter((a) => !poolSlugs.has(a.slug)).slice(0, 6).map((a) => getArticleMeta(a));
...
Resta in contatto:
<a href="https://ombreeluci.us17.list-manage.com/subscribe?u=00c5dad63480d9601563b5692&id=efd099264d" target="_blank" rel="noopener noreferrer">iscriviti alla newsletter</a> </p> </div> </section> </main>  `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": async ($$result3) => renderTemplate(_a || (_a = __template([' <script type="application/ld+json">', "<\/script> "])), unescapeHTML(JSON.stringify([
    {
      "@context": "https://schema.org",
      "@type": "Organization",
      "name": "Ombre e Luci",
      "url": "https://ombreeluci.it",
      "logo": "https://ombreeluci.it/logo.svg",
      "sameAs": [
        "https://www.facebook.com/OmbreeLuciRivista/",
        "https://www.instagram.com/ombreeluci_magazine/",
        "https://x.com/Ombre_Luci",
        "https://www.youtube.com/channel/UCypEHP-N_RaUiz1BcBsplVQ"
      ],
      "foundingDate": "1983",
      "description": "Rivista trimestrale sulla disabilit\xE0 e sulla fragilit\xE0 umana. Dal 1983.",
      "publisher": {
        "@type": "Organization",
        "name": "Associazione Fede e Luce A.P.S.",
        "url": "https://www.fedeeluce.it"
      }
    },
    {
      "@context": "https://schema.org",
      ...
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://ombreeluci.it/cerca?q={search_term_string}",
...
const $$file = "C:/Users/berto/Documents/Ombreeluci/src/pages/index.astro";
const $$url = "";
