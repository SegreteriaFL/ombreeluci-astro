...
const articolo = [
	{
		...
		it: {
			...
			testo: "Da oltre 40 anni raccogliamo storie di fragilità, disabilità e inclusione. Non nascondiamo le ombre — le fatiche, i dolori, le barriere — ma cerchiamo sempre la luce che emerge: nelle relazioni, nelle conquiste, nella bellezza di chi impara ad accogliere la diversità come ricchezza. Possiamo continuare a farlo grazie a chi sceglie di sostenerci.",
			cta: "Abbonati"
		},
		en: {
	...
	},
	{
		...
		it: {
			...
			testo: "Gli articoli di Ombre e Luci sono e saranno sempre gratuiti, perché crediamo che siano un bene per tutti. Non vogliamo alzare muri: vogliamo che la luce circoli. Ma possiamo continuare solo grazie a chi sceglie di sostenerci con un abbonamento. È un gesto di giustizia e di cura.",
			cta: "Sostienici"
		},
		en: {
...
const archivio = {
	...
	it: {
		...
		sottotitolo: "Quarant'anni di storie, riflessioni e incontri sulla fragilità e sulla dignità della persona.",
		cta: "Contribuisci"
	},
	en: {
