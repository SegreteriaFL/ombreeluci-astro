...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  const lang = getLangFromUrl(pathname);
  const ultimoNumero = numeriData.sort((a, b) => {
