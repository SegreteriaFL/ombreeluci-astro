...
2. **Fase 0 (audit) eseguita il 2026-08-10** — esito: **non ancora sicuro ritirare il Worker**. Confronto regola-per-regola completo in Appendice A8: trovati gap reali oltre a Rule R (trailing slash), già noto — vedi tabella in "Piano operativo" sotto. Il proxy WordPress legacy verso Aruba, che la Fase 0 dell'audit del 27/7 doveva ancora misurare, **è già stato ritirato quello stesso giorno** (commit `a69b441f`, dati e decisione in Appendice A2-bis / `STATO.md § [BUG] Segnalazioni 2026-07-27`) — non è più un punto aperto.
