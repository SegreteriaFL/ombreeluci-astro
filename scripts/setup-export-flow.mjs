...
const BUILD_SCRIPT = `module.exports = async function(data) {
  ...
  const result = {
    _prompt: "Traduci i campi in _translate dall'italiano in inglese. Regole:\\n\\n1. Restituisci un JSON con la stessa struttura di questo file: _meta e _copy_invariant invariati, solo i campi in _translate tradotti.\\n2. Preserva tutti i tag HTML esattamente come sono nel campo corpo. Non aggiungere, rimuovere o modificare nessun tag o attributo.\\n3. Per le didascalie foto con formato \\"Foto di X su Unsplash\\" traduci in \\"Photo by X on Unsplash\\".\\n4. Non modernizzare mai la terminologia sulla disabilit\\u00e0: spastico\\u2192spastic, subnormale\\u2192subnormal, handicappato\\u2192handicapped, mongoloide\\u2192mongoloid, ritardato\\u2192retarded. Sono documenti d'archivio.\\n5. Se l'articolo contiene grammatica non standard (scritto da bambini o persone con disabilit\\u00e0 cognitiva), preserva lo stesso livello di irregolarit\\u00e0 nella traduzione.\\n6. Non tradurre i nomi propri: \\"Fede e Luce\\", \\"Ombre e Luci\\", citt\\u00e0 italiane, titoli \\"don/padre/suor\\".\\n7. I titoli devono suonare come headline originali in inglese, non come traduzioni letterali.\\n8. Non aggiungere spiegazioni o note. Restituisci solo il JSON tradotto, senza markdown fence o testo aggiuntivo.",
    _meta: {
      export_version: "1.0",
      source_id: a.id,
      source_slug: a.slug,
