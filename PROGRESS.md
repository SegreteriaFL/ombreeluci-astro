...
| US-09 | **Anni sbagliati su alcuni numeri archivio** — oel-164 (2023), oel-156 (2021) mostrano anno errato | Query Directus per trovare quanti numeri hanno `anno_pubblicazione` incoerente con il numero progressivo; correggere via PATCH o re-import |
